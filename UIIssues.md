...
این لیست شامل تعدادی مخزن پیشنهادی برای حل issue های میانترم است؛ این یعنی حل issue از سایر مخازن هم مجاز است.

توجه کنید که پیش از اقدام برای حل issue ها، لطفا با استاد هماهنگ کنید.
